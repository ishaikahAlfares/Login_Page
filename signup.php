...
<?php
 if (isset($_POST["signup"])) {
                $nameValue = $_POST['u'];
                $EmailValue = $_POST['em'];
                $PasswordValue = $_POST['p'];
                $sql = "INSERT INTO `users` (`name`, `email`, `password`) VALUES ('$nameValue', '$EmailValue', '$PasswordValue ')";
...
.Sign-up { 
 ...
 h1 { color: #fff; text-shadow: 0 0 10px rgba(0,0,0,0.3); letter-spacing:2px; text-align:center; margin-left:40%;  }
...
<body>
<div class="Sign-up">
<img src="robot2.png" width="600" height="290">
    <div class="container">
        <form method="post">
    <label for="name">Name:</label><br>
      <input type="text" name="u" id="name" placeholder="Enter your Username" required="required" />
      <label for="Email">Email:</label><br>
      <input type="text" name="em" id="Email" placeholder="Enter your Email" required="required" />
      <label for="password">Password:</label><br>
      <input type="password" name="p" id="password" placeholder="Enter your Password" required="required" /><br><br>
        <button type="submit" class="btn btn-primary btn-block btn-large" name="signup">Sign up</button></form></div>
        <br><br>
        </div>
